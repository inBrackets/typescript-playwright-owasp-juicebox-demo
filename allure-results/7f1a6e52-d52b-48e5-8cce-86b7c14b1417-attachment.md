...
- Name: sqli.spec.ts >> SQL Injection – Authentication Bypass (OWASP A03:2021) >> tautology comment variant must not bypass login
- Location: src\tests\sqli.spec.ts:41:7
      ...
      - generic [ref=e58]:
        - generic [ref=e61]:
          - generic [ref=e62]:
            - text: Email
            - generic [ref=e63]: "*"
          - textbox [ref=e65]: "' OR '1'='1"
        - generic [ref=e69]:
          - generic [ref=e70]:
            - text: Password
            - generic [ref=e71]: "*"
          - textbox [active] [ref=e73]: IrrelevantPassword1!
